...
data =read.csv("PhaseI_magnitudes_lambda_pt7.csv",header = FALSE)  # G=100 macro reps W=1000 contiguous windows waFm stats taking in 0th to 2500th mags
data2=read.csv("PhaseII_magnitudes_lambda_pt7.csv",header=FALSE)    # G=100 macro reps W=1200 contiguous windows
