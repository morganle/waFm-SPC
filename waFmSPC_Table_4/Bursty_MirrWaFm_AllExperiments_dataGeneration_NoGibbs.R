...
for (kk in 1:G){
  tic()
   ...
   ## Phase 2 - ARL_0 experiment
    ...
    #write.table(t(mag_store_all),"PhaseI_magnitudes_lambda_pt7.csv",sep=",",row.names = FALSE,col.names = FALSE,append = TRUE)
    #write.table(t(mag_store_all_p2),"PhaseII_magnitudes_lambda_pt7.csv",sep=",",row.names = FALSE,col.names = FALSE,append = TRUE)

    toc()
}


write.table(mag_store_all_matrix,"PhaseI_magnitudes_lambda_pt7NoGibbs.csv",
            sep=",",row.names = FALSE,col.names = FALSE,append = FALSE)
write.table(mag_store_all_p2_matrix,"PhaseII_magnitudes_lambda_pt7NoGibbs.csv",
            sep=",",row.names = FALSE,col.names = FALSE,append = FALSE)
