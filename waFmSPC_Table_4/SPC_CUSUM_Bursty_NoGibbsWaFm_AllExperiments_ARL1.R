...
#print(id)
data = read.csv("Experiment_Settings_ARL1_CUSUM_NoGibbs.csv",header=TRUE)
#read = data[id,]
read = data[1,]
...
for (kk in 1:G){
 ...
 OO<-c(W,mag_L,mag_U)
 write.table(t(OO),paste("BurstyArrivals/CUSUM_NoGibbsWaFm_bursty_SerDown_ARL1_pt1.csv",sep=""),sep=",",row.names=FALSE,col.names=FALSE,append=TRUE)
 OO<-c(store_ARL)
 write.table(t(OO),paste("BurstyArrivals/CUSUM_NoGibbsWaFm_bursty_SerDown_ARL1_pt1.csv",sep=""),sep=",",row.names=FALSE,col.names=FALSE,append=TRUE)
...
# ARL Down pt 2 -----------------------------------------------------------
 ...
 OO<-c(W,mag_L,mag_U)
 write.table(t(OO),paste("BurstyArrivals/CUSUM_NoGibbsWaFm_bursty_SerDown_ARL1_pt2.csv",sep=""),sep=",",row.names=FALSE,col.names=FALSE,append=TRUE)
 OO<-c(store_ARL)
 write.table(t(OO),paste("BurstyArrivals/CUSUM_NoGibbsWaFm_bursty_SerDown_ARL1_pt2.csv",sep=""),sep=",",row.names=FALSE,col.names=FALSE,append=TRUE)
...
# ARL Up pt 1 -----------------------------------------------------------
 ...
 mean(store_ARL) 
 OO<-c(W,mag_L,mag_U)
 write.table(t(OO),paste("BurstyArrivals/CUSUM_NoGibbsWaFm_bursty_SerUp_ARL1_pt1.csv",sep=""),sep=",",row.names=FALSE,col.names=FALSE,append=TRUE)
 OO<-c(store_ARL)
 write.table(t(OO),paste("BurstyArrivals/CUSUM_NoGibbsWaFm_bursty_SerUp_ARL1_pt1.csv",sep=""),sep=",",row.names=FALSE,col.names=FALSE,append=TRUE)
...
# ARL Up pt 2 -----------------------------------------------------------
 ...
 mean(store_ARL) 
 OO<-c(W,mag_L,mag_U)
 write.table(t(OO),paste("BurstyArrivals/CUSUM_NoGibbsWaFm_bursty_SerUp_ARL1_pt2.csv",sep=""),sep=",",row.names=FALSE,col.names=FALSE,append=TRUE)
 OO<-c(store_ARL)
 write.table(t(OO),paste("BurstyArrivals/CUSUM_NoGibbsWaFm_bursty_SerUp_ARL1_pt2.csv",sep=""),sep=",",row.names=FALSE,col.names=FALSE,append=TRUE)
